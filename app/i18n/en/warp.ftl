...
keybinding-desc-workspace-left-panel-git-history = Left Panel: Git history
...
workspace-left-panel-git-history = Git history
git-history-title = Git history
git-history-refresh = Refresh Git history
...
git-history-diff-empty-selection = Select a committed file from the left panel.
git-history-diff-loading = Loading historical diff
git-history-diff-load-error = Failed to load historical diff
git-history-diff-binary = This is a binary file. No text diff is available.
git-history-diff-too-large = This historical diff is too large to display.
