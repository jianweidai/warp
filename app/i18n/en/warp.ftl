...
keybinding-desc-workspace-left-panel-git-history = Left Panel: Source control
...
workspace-left-panel-git-history = Source control
git-working-tree-title = Changes
git-working-tree-staged = Staged changes
git-working-tree-unstaged = Changes
git-working-tree-loading = Loading working tree changes…
git-working-tree-load-error = Failed to load working tree changes
git-working-tree-clean = No working tree changes.
git-working-tree-diff-title = Working tree diff
git-sidebar-show-history = History
git-sidebar-show-changes = Changes
git-history-title = Git history
git-history-refresh = Refresh Git
git-history-loading = Loading Git history…
git-history-loading-files = Loading changed files…
git-history-load-error = Failed to load Git history
git-history-empty = No commits found on the current branch.
git-history-no-local-repository = No local Git repository is focused. Remote and SSH repositories are not supported in this first version.
git-history-no-changed-files = No changed files recorded for this commit.
git-history-load-more = Load more
git-history-diff-title = Git history diff
git-history-diff-empty-selection = Select a changed file from the left panel.
git-history-diff-loading = Loading historical diff
git-history-diff-load-error = Failed to load diff
git-history-diff-binary = This is a binary file. No text diff is available.
git-history-diff-too-large = This diff is too large to display.
git-history-diff-hidden-bidi = This diff contains hidden bidirectional control characters. Check the original content carefully.
git-history-diff-no-text-changes = This file has no text content changes.
git-history-files-load-error = Failed to load changed files
