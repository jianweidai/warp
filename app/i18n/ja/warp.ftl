...
keybinding-desc-workspace-left-panel-git-history = 左パネル: ソース管理
...
workspace-left-panel-git-history = ソース管理
git-working-tree-title = 変更
git-working-tree-staged = ステージ済みの変更
git-working-tree-unstaged = 変更
git-working-tree-loading = 作業ツリーの変更を読み込み中…
git-working-tree-load-error = 作業ツリーの変更を読み込めませんでした
git-working-tree-clean = 作業ツリーに変更はありません。
git-working-tree-diff-title = 作業ツリーの差分
git-sidebar-show-history = 履歴
git-sidebar-show-changes = 変更
git-history-title = Git 履歴
git-history-refresh = Git を更新
git-history-loading = Git 履歴を読み込み中…
git-history-loading-files = 変更ファイルを読み込み中…
git-history-load-error = Git 履歴の読み込みに失敗しました
git-history-empty = 現在のブランチにコミットはありません。
git-history-no-local-repository = フォーカス中のローカル Git リポジトリがありません。初版ではリモートと SSH リポジトリをサポートしません。
git-history-no-changed-files = このコミットに記録された変更ファイルはありません。
git-history-load-more = さらに読み込む
git-history-diff-title = Git 履歴の差分
git-history-diff-empty-selection = 左パネルから変更されたファイルを選択してください。
git-history-diff-loading = 履歴の差分を読み込み中
git-history-diff-load-error = 差分の読み込みに失敗しました
git-history-diff-binary = バイナリファイルのため、テキスト差分を表示できません。
git-history-diff-too-large = この差分は大きすぎるため表示できません。
git-history-diff-hidden-bidi = この差分には不可視の双方向制御文字が含まれています。元の内容を慎重に確認してください。
git-history-diff-no-text-changes = このファイルにはテキストの変更がありません。
git-history-files-load-error = 変更ファイルの読み込みに失敗しました
