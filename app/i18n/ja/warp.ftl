...
keybinding-desc-workspace-left-panel-git-history = 左パネル: Git 履歴
...
workspace-left-panel-git-history = Git 履歴
git-history-title = Git 履歴
git-history-refresh = Git 履歴を更新
...
git-history-diff-empty-selection = 左パネルからコミット済みのファイルを選択してください。
git-history-diff-loading = 履歴の差分を読み込み中
git-history-diff-load-error = 履歴の差分の読み込みに失敗しました
git-history-diff-binary = バイナリファイルのため、テキスト差分を表示できません。
git-history-diff-too-large = この履歴差分は大きすぎるため表示できません。
