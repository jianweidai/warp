...
keybinding-desc-workspace-left-panel-git-history = 左侧面板：Git 提交历史
...
workspace-left-panel-git-history = Git 提交历史
git-history-title = Git 提交历史
git-history-refresh = 刷新 Git 提交历史
...
git-history-diff-empty-selection = 请从左侧选择一个提交文件。
git-history-diff-loading = 正在加载历史 Diff
git-history-diff-load-error = 历史 Diff 加载失败
git-history-diff-binary = 这是二进制文件，无法显示文本 Diff。
git-history-diff-too-large = 此文件的历史 Diff 过大，暂不显示。
