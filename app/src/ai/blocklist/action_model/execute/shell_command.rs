...
///
/// 1. `Some(OnCompletion)` —— 把 timeout 从 `MAX_AGENT_DELAY_DURATION`
...
fn effective_read_shell_command_delay(
    ...
    let delay = force_short_polling_delay_for_command(command, delay);
